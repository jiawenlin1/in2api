...
class TestCreat():
    ...
    #====================SQL server======================
    @allure.story("接口名称：测试sqlserver连接互联项")
    @pytest.mark.parametrize('caseinfo', read_testcase_file('/testcase/9_Interconnection/test_interconnection(sqlserver).yml'))
    def test_testinterconnection_sqlserver(self, caseinfo, truncate_sqlerver_fixture):
        allure.dynamic.title(caseinfo['name'])
        allure.dynamic.description(caseinfo['name'])
        RequestUtil().analysis_yaml(caseinfo)
        time.sleep(2)

    @allure.story("接口名称：创建sqlserver互联项")
    @pytest.mark.parametrize('caseinfo', read_testcase_file('/testcase/9_Interconnection/create_interconnection(sqlserver).yml'))
    def test_create_interconnection_sqlserver(self, caseinfo):
        allure.dynamic.title(caseinfo['name'])
        allure.dynamic.description(caseinfo['name'])
        RequestUtil().analysis_yaml(caseinfo)
        time.sleep(2)
    ...
    @allure.story("接口名称：创建映射表")
    @pytest.mark.parametrize('caseinfo', read_testcase_file('/testcase/9_Interconnection/create_mapping_table(sqlserver).yml'))
    def test_create_mapping_table_sqlserver(self, caseinfo):
        allure.dynamic.title(caseinfo['name'])
        allure.dynamic.description(caseinfo['name'])
        RequestUtil().analysis_yaml(caseinfo)

    @allure.story("接口名称：保存配置-插入")
    @pytest.mark.parametrize('caseinfo', read_testcase_file('/testcase/9_Interconnection/save_config(sqlserver).yml'))
    def test_save_config_sqlserver(self, caseinfo):
        allure.dynamic.title(caseinfo['name'])
        allure.dynamic.description(caseinfo['name'])
        RequestUtil().analysis_yaml(caseinfo)
    ...
    @allure.story("接口名称：下发变量1")
    @pytest.mark.parametrize('caseinfo', read_testcase_file('/testcase/9_Interconnection/write_var.yml'))
    def test_write_var_sqlserver(self, caseinfo):
        allure.dynamic.title(caseinfo['name'])
        allure.dynamic.description(caseinfo['name'])
        RequestUtil().analysis_yaml(caseinfo)
        time.sleep(2)
    ...
    @allure.story("接口名称：执行插入语句")
    @pytest.mark.parametrize('caseinfo', read_testcase_file('/testcase/9_Interconnection/execute_insert(sqlserver).yml'))
    def test_execute_insert_sqlserver(self, caseinfo,truncate_sqlerver_fixture):
        allure.dynamic.title(caseinfo['name'])
        allure.dynamic.description(caseinfo['name'])
        RequestUtil().analysis_yaml(caseinfo)
    ...
    @allure.story("接口名称：执行查询语句")
    @pytest.mark.parametrize('caseinfo', read_testcase_file('/testcase/9_Interconnection/execute_query(sqlserver).yml'))
    def test_execute_query_sqlserver(self, caseinfo):
        allure.dynamic.title(caseinfo['name'])
        allure.dynamic.description(caseinfo['name'])
        RequestUtil().analysis_yaml(caseinfo)
        time.sleep(1)
    ...
    @allure.story("接口名称：下发变量2")
    @pytest.mark.parametrize('caseinfo', read_testcase_file('/testcase/9_Interconnection/write_var2.yml'))
    def test_write_var2_sqlserver(self, caseinfo):
        allure.dynamic.title(caseinfo['name'])
        allure.dynamic.description(caseinfo['name'])
        RequestUtil().analysis_yaml(caseinfo)
        time.sleep(2)
    ...
    @allure.story("接口名称：执行修改语句")
    @pytest.mark.parametrize('caseinfo', read_testcase_file('/testcase/9_Interconnection/execute_modify(sqlserver).yml'))
    def test_execute_modify_sqlserver(self, caseinfo):
        allure.dynamic.title(caseinfo['name'])
        allure.dynamic.description(caseinfo['name'])
        RequestUtil().analysis_yaml(caseinfo)
        time.sleep(1)
    ...
    @allure.story("接口名称：下发变量3")
    @pytest.mark.parametrize('caseinfo', read_testcase_file('/testcase/9_Interconnection/write_var3.yml'))
    def test_write_var3_sqlserver(self,caseinfo,truncate_sqlerver_fixture):
        allure.dynamic.title(caseinfo['name'])
        allure.dynamic.description(caseinfo['name'])
        RequestUtil().analysis_yaml(caseinfo)
        time.sleep(2)
    ...
    @allure.story("接口名称：定时触发-插入")
    @pytest.mark.parametrize('caseinfo', read_testcase_file('/testcase/9_Interconnection/insert_time_triggered(sqlserver).yml'))
    def test_insert_time_triggered_sqlserver(self, caseinfo):
        allure.dynamic.title(caseinfo['name'])
        allure.dynamic.description(caseinfo['name'])
        RequestUtil().analysis_yaml(caseinfo)
        time.sleep(5)
    ...
    @allure.story("接口名称：禁用-定时插入映射表")
    @pytest.mark.parametrize('caseinfo', read_testcase_file('/testcase/9_Interconnection/stop_time_mapping_table(sqlserver).yml'))
    def test_stop_time_mapping_table_sqlserver(self, caseinfo,truncate_sqlerver_fixture):
        allure.dynamic.title(caseinfo['name'])
        allure.dynamic.description(caseinfo['name'])
        RequestUtil().analysis_yaml(caseinfo)
        time.sleep(2)
    ...
    @allure.story("接口名称：变量触发-插入")
    @pytest.mark.parametrize('caseinfo', read_testcase_file('/testcase/9_Interconnection/insert_var_triggered(sqlserver).yml'))
    def test_insert_var_triggered_sqlserver(self, caseinfo):
        allure.dynamic.title(caseinfo['name'])
        allure.dynamic.description(caseinfo['name'])
        RequestUtil().analysis_yaml(caseinfo)
        time.sleep(5)
    ...
    @allure.story("接口名称：禁用-变量触发映射表")
    @pytest.mark.parametrize('caseinfo', read_testcase_file('/testcase/9_Interconnection/stop_var_mapping_table(sqlserver).yml'))
    def test_stop_var_mapping_table_sqlserver(self, caseinfo, truncate_sqlerver_fixture):
        allure.dynamic.title(caseinfo['name'])
        allure.dynamic.description(caseinfo['name'])
        RequestUtil().analysis_yaml(caseinfo)
        time.sleep(2)
    ...
    @allure.story("接口名称：报警触发-插入")
    @pytest.mark.parametrize('caseinfo', read_testcase_file('/testcase/9_Interconnection/insert_alarm_triggered(sqlserver).yml'))
    def test_insert_alarm_triggered_sqlserver(self, caseinfo):
        allure.dynamic.title(caseinfo['name'])
        allure.dynamic.description(caseinfo['name'])
        RequestUtil().analysis_yaml(caseinfo)
        time.sleep(5)
    ...
    @allure.story("接口名称：禁用报警触发映射表")
    @pytest.mark.parametrize('caseinfo', read_testcase_file('/testcase/9_Interconnection/stop_alarm_mapping_table(sqlserver).yml'))
    def test_stop_alarm_mapping_table_sqlserver(self, caseinfo):
        allure.dynamic.title(caseinfo['name'])
        allure.dynamic.description(caseinfo['name'])
        RequestUtil().analysis_yaml(caseinfo)
        time.sleep(5)
